...
!function (e) {
    ...
    var t = e.layui && layui.define, a = {
        ...
        d = "layui-laydate-media", m = "layui-laydate-list", c = "laydate-selected", u = "layui-laydate-hint",
    ...
    v.isLeapYear = function (e) {
        ...
        var t = this, a = t.config, n = "yyyy|y|MM|M|dd|d|HH|H|mm|m|ss|s", l = "media" === a.position,
        ...
        var e = this, t = e.config, a = e.lang(), n = "media" === t.position, l = e.elem = lay.elem("div", {
                id: e.elemID,
        ...
        var t, a, l = this, i = (new Date, l.config), r = l.lang(), o = i.dateTime = i.dateTime || l.systemDate(),
            ...
            d = (l.isInput(s) ? "val" : "html", l.isInput(s) ? s.value : "media" === i.position ? "" : s.innerHTML),
            m = function (e) {
        ...
        return "media" === a.position || lay(n)[l](e || ""), this
        ...
        }), a.calendar(null, t)) : "media" === n.position ? a.calendar().done().done(null, "change") : "date" === n.type ? a.setValue(a.parse()).remove().done() : "datetime" === n.type && a.calendar().done(null, "change"))
    }, v.prototype.tool = function (e, t) {
        var a = this, n = a.config, l = a.lang(), i = n.dateTime, r = "media" === n.position, o = {
            datetime: function () {
...
!function (e, t) {
    ...
    return pe.fn.load = function (e, t, n) {
        ...
        offset: function (e) {
            ...
            return this.map(function () {
                for (var e = this.offsetParent; e && !pe.nodeName(e, "html") && "media" === pe.css(e, "position");) e = e.offsetParent;
                return e || pt
            })
        }
